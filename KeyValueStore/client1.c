...
int main() {
    ...
    printf("calling put function ---- %d \n", kv739_put("xyz", "xyzz", oldValue));
    printf("old value for key xyz is === %s\n ", oldValue);
    printf("this should return an error: getting key value a from the server --- %d ", kv739_get("xyz", oldValue));
    printf("old value for key xyz is === %s\n ", oldValue);
